...
class CourseController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($courses->isEmpty()) {
            \Session::flash('course', 'Chưa đăng ký bất kỳ khóa học nào');
        } else {
    ...
    public function store(Request $request)
    {
        ...
        $input = $request->all();
        $input['thumbnail'] = $request->file('thumbnail')->storePublicly('images', 'public');
        $input['file'] = $request->file('file')->storePublicly('file', 'public');
    ...
    public function unenroll(Course $course)
    {
        ...
        UserCourse::where('user_id', '=', Auth::id())
                    ...
                    ->delete();
        \Session::flash('flash_message', 'Bạn đã bị hủy đăng ký khỏi khóa học!');
        return redirect(route('home'));
    }
    ...
    public function complete(Course $course)
    {
        ...
        \Session::flash('flash_message', 'Khóa học được đánh dấu là đã hoàn thành!');
    ...
    public function destroy($r)
    {
        ...
        $course->delete();
        \Session::flash('flash_message', 'Khóa học đã bị xóa!');
        // dd($course);
