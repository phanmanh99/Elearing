...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        \Session::flash('flash_message', 'Người dùng mới đã được tạo!');
    ...
    public function update(Request $request, $user)
    {
        ...
        \Session::flash('flash_message', 'Người dùng đã được cập nhật!');
        return redirect(route('user.index'));
    }
    ...
    public function destroy($id)
    {
        $user = User::find($id);
        $user->delete();
        \Session::flash('flash_message', 'Người dùng đã bị xóa!');
        return redirect(route('user.index'));
    }
}
