@section('header')
    ...
    <a class="navbar-brand" id= "navbar-logo" style="height: 50px; width: 50px;">{{ Html::image('images/logo.jpg', 'LOGO', array('class'=> 'logo')) }}</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                @if (Auth::check() && Auth::user()->role()->first()->name = "Author")
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard') }}">Phê duyệt</a>
                    </li>
                @endif
                <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ route('home') }}">Khóa học</a>
                </li>
                ...
                @if (Auth::check())
                    <li class="nav-item">
                            <a class="nav-link" href="{{ route('user.account', [Auth::id()]) }}">Thông tin</a>
                    </li>
                @endif
            </ul>
